    ...
    private var contentCard: some View {
        DICard {
            VStack(alignment: .leading, spacing: DISpacing.sm) {
                ...
                Text("Items shown as link-only present metadata with a link to the original page until publication permission is confirmed.")
                    .font(.footnote)
    ...
    private var chimeCard: some View {
        DICard {
            VStack(alignment: .leading, spacing: DISpacing.sm) {
                ...
                Text("The short prayer chime used for alerts is an original recording created for this app.")
                    .font(.subheadline)
                    .foregroundStyle(DIColor.textPrimary)
            }
        }
